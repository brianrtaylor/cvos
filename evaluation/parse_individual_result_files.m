%-----------------------------------------------------------------------------
% parse_individual_result_files
%
% Evaluation suite saves individual result files into the same folders where 
% the Tracks.dat files are.
%-----------------------------------------------------------------------------
...
TRAINSET = {'cars2', 'cars3', 'cars6', 'cars7', 'cars8', 'cars9', ...
'marple1', 'marple3', 'marple5', 'marple8', 'marple10', 'marple11', ...
'marple13', 'bear1', 'bear2', 'cats2', 'cats4', 'cats5', 'cats7', ...
'ducks1', 'horses1', 'horses3', 'horses6', 'lion2', 'meerkats1', ...
'people4', 'people5', 'rabbits1', 'rabbits5'};
%-----------------------------------------------------------------------------
