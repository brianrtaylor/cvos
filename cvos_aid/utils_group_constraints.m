%-----------------------------------------------------------------------------
% utils_group_constraints
%
% groups nearby constraints for faster perturbation
%
% @return: groups: the group each constraint is assigned to
% @param: constraints: pre-perturbed constraints
% @param: imsize: image dimensions (rows, cols)
% @param: group_size: number of constraints in each group
%-----------------------------------------------------------------------------
