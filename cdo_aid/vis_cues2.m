function [W, W2, W3] = vis_cues2(img, constraints, constraint_weights, thresh)
...
if ~isempty(constraints);
  ...
  W2 = 0.1*W2 + 0.9*(W2.*repmat(occd(:,:,1)==0,[1 1 3]) + occd);
  W3 = 0.1*W3 + 0.9*(W3.*repmat(occr(:,:,1)==0,[1 1 3]) + occr);
