...
function [local_gmm_bg, local_gmm_fg] = ...
    ...
    [mu_fg, cov_fg, pi_fg, mu_bg, cov_bg, pi_bg] = ...
      learn_constraint_gmm_mex( I0d, ...
      occluded_smoothed, occluder_smoothed, ...
      W_binary, double(layers), ...
      PTS_OCCD, PTS_OCCR, groups, EPS, ...
      params.NUM_GMM_CLUSTERS, ...
      params.NUM_GMM_REPETITIONS, ...
      params.NUM_GMM_ITERATIONS );
