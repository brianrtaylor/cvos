...
[pts_occd_out, pts_occr_out, gmm_weights] = perturb_constraints_mex(...
  ...
  params.EDGE_DISTANCE_COST, params.TRANSLATION_COST, params.MAX_SHIFT, ...
  params.NUM_ROTATION, params.MAX_ROTATION, params.ROTATION_COST, ...
  params.MAX_STRETCH, params.STRETCH_COST, params.INVALID_COST );      
try
