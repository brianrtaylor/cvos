...
%
%   Edited: btay 01/24/2012 to return handle to image display object as well <-- I'm not sure about this btay 2/28/2012
%
% Examples:
%   sc(image) %   sc(image, limits)
%   sc(image, map)
%   sc(image, limits, map)
%   sc(image, map, limits)
...
%% Only display if the output isn't used (or if we specificall want the handle)
